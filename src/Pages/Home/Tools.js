    ...
    return (
        <div>
            ...
            <div className='flex justify-center'>
                {
                    tools?.map(tool => <div key={tool._id} class="card lg:max-w-lg bg-base-100 shadow-xl">
                        ...
                        <div class="card-body items-center text-center">
                            ...
                            <div class="card-actions">
                                <button onClick={handlePurchasePage} class="btn btn-primary">Purchase Now</button>
                            </div>
                        </div>
                    </div>)
                }
