    ...
    return (
        <div>
            ...
            <form onSubmit={handleTools} className='grid grid-cols-1 gap-2 justify-items-center'>
                <input type="text" placeholder='Tool Name' name='name' className="input input-bordered input-accent w-full max-w-xs" />
                <input type="text" placeholder='ShortDescription' name='shortDescription' className="input input-bordered input-accent w-full max-w-xs" />
                <input type="text" placeholder='Photo url' name='img' className="input input-bordered input-accent w-full max-w-xs" />
                <input type="text" placeholder='Price' name='price' className="input input-bordered input-accent w-full max-w-xs" />
                <input type="text" placeholder='MinimumOrderQuantity' name='minimumOrderQuantity' className="input input-bordered input-accent w-full max-w-xs" />
                <input type="text" placeholder='AvailableQuantity' name='availableQuantity' className="input input-bordered input-accent w-full max-w-xs" />
